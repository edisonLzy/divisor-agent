...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-md border-2 border-border p-[2px] text-muted-foreground shadow-[var(--hard-shadow-sm)] group-data-[orientation=horizontal]/tabs:h-9 group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col data-[variant=line]:rounded-none data-[variant=line]:border-0 data-[variant=line]:shadow-none",
  {
    variants: {
      variant: {
        default: "bg-muted",
